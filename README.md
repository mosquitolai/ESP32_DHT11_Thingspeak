# Using-ESP32-and-ThingSpeak-to-record-temperature-data
利用ESP32與ThingSpeak記錄溫度數據
...
//請修改為API Key，並將https改為http
String url = "http://api.thingspeak.com/update?api_key=API";

int pinDHT11 = 13;//假設DHT11接在腳位GPIO14，麵包板左側序號8
